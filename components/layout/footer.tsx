...
// Custom SVG definitions for brand icons
...
export function Footer() {
  return (
    <footer className="border-t border-white/5 bg-zinc-950/40 py-12 text-muted-foreground">
      <Container className="flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
        
        {/* Left: Brand typography and technical focus */}
        ...
        {/* Center: Social links navigation */}
        ...
        <span className="text-xs font-mono text-zinc-600">
          &copy; 2026 Anshu Mehra. All rights reserved.
        </span>
